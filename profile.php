	...
	<div class='panel panel-info'>
		...
		<div class='panel-body'>
			<center><h4><?php echo $user; ?></h4>
				<br>
				<center><img alt="User Pic" src="images/man.png" class="img-circle img-responsive" width="150"
							 height="150">
					<br>

					<form action="profile.php" method="post">
						<h4>Current Password</h4>
						<input type="password" name="curPass" class="form-control" value=""
						...
						<br>
						<button type="submit" name="updateButton" class="btn btn-primary btn-lg btn-block btn-outline">
							Update
						</button>
					</form>
		</div>
