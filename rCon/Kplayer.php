...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
	...
	<div class="table-responsive">
		<table class="table table-striped" style="margin-top: -10px">
            ...
            echo '</table></div>';
            ?>
			<p>To use the kick feature you need to find the player ID, this is found by pressing the battleye list and
				typing in the [#] value. This is betwen 0-amount of players on server. So please check, this is NOT uid
				or GUID!</p>
			</tbody>
		</table>
	</div>
