...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
	...
	<p class="page-header">Kick menu - This allows you to chose to kick the user through the use of RCON or the use of
		the server command, RCON allows you to give a reason for your kick however is a little more compilcated to use.
		Server kick however is very simple to use but is unable to give a reason!</p>
