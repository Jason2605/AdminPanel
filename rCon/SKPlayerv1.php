...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
	...
	<p class="page-header">Gives you the ability to kick a player off the server. This can be sent to the server for any
		player in the database, obviously if they are offline nothing will happen... Check the battleye list for players
		online!.</p>
