...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
	...
	<form action='editPlayer.php' method='post'>
		...
		<div class="btn-group" role="group" aria-label="...">
			<button type="button" class="btn btn-primary btn-outline" data-toggle="modal" data-target="#myModal">Player
				Inventory
			</button>
	</form>
</div>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class='panel panel-info'>
					...
					<div class='panel-body'>
						<div class="well well-lg">
							<pre> <?php echo $player->civ_gear; ?> </pre>
						</div>
					</div>
				</div>
				...
				<div class='panel panel-info'>
					...
					<div class='panel-body'>
						<div class="well well-lg">
							<pre> <?php echo $player->cop_gear; ?> </pre>
						</div>
					</div>
				</div>
				...
				<div class='panel panel-info'>
					...
					<div class='panel-body'>
						<div class="well well-lg">
							<pre> <?php echo $player->med_gear; ?> </pre>
						</div>
					</div>
				</div>
