			...
			<div class="row">
				<div class="col-lg-6">
					<div class="input-group">
						<input type="text" class="form-control" style="width: 300px; margin-top: 20px;"
							   name="SearchValue" placeholder="UID...">
						<span class="input-group-btn">
          					<input class="btn btn-default" style="margin-top: 20px;" name="search" type="submit"
								   value="Search">
          				  </span>
					</div><!-- /input-group -->
				</div><!-- /.col-lg-6 -->
