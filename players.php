			...
			<div class="row">
				<div class="col-lg-6">
					<div class="input-group">
						<input type="text" class="form-control" style="width: 300px;" name="SearchValue"
							   placeholder="Player name/UID/ID...">
	...
	<div class="table-responsive">
		<table class="table table-striped" style="margin-top: 0px">
			...
			<tr>
				...
				<th>GUID</th>
				<th>
					<form action="players.php?search=cash" method="post"><input class='btn-link' type='submit'
																				name='orderCash' value="Player Cash">
					</form>
				</th>
				<th>
					<form action="players.php?search=bank" method="post"><input class='btn-link' type='submit'
																				name='orderBank' value="Player Bank">
					</form>
				</th>
				<th>
					<form action="players.php?search=cop" method="post"><input class='btn-link' type='submit'
																			   name='orderCop' value="Cop Level"></form>
				</th>
				<th>
					<form action="players.php?search=medic" method="post"><input class='btn-link' type='submit'
																				 name='orderMedic' value="Medic Level">
					</form>
				</th>
				<th>
					<form action="players.php?search=admin" method="post"><input class='btn-link' type='submit'
																				 name='orderAdmin' value="Admin Level">
					</form>
				</th>
				<th>View Stats</th>
			</tr>
			...
			<nav>
				<ul class="pagination">
                    <?php if ($currentpage != 1) {
                        ?>
						<li>
							<a href="players.php?search=<?php echo $search; ?>&page=<?php echo $minusPage; ?>"
							   aria-label="Previous">
                ...
                ?>
					...
					<li><?php
                        ...
                        ?>
					<li>
						<a href="players.php?search=<?php echo $search; ?>&page=<?php echo $addPage; ?>"
						   aria-label="Next">
